package no.nav.eessi.pensjon.errorhandler
...
class PenErrorHandler: ResponseErrorHandler {
    ...
    /**
     * PenErrorHandler er en utvidelse av DefaultResponseErrorHandler som håndterer
     * HTTP-feil for PEN integrasjon.
     *
     ...
     */
    private val logger = LoggerFactory.getLogger(PenErrorHandler::class.java)
    ...
    private fun getCallingClasses(): List<String> {
        ...
        val excludedClasses =
            setOf(this::class.java.name, "ResponseErrorHandler", "RestTemplate", "MetricsHelper", "Metric")
